...
![image-20250312154646141](/Users/zhangjiaqi62/Library/Application Support/typora-user-images/image-20250312154646141.png)
...
![image-20250312155515775](/Users/zhangjiaqi62/Library/Application Support/typora-user-images/image-20250312155515775.png)
...
用于在服务器端将一个请求从一个资源转发到另一个资源，而不需要客户端（如浏览器）再次发出请求。

客服端的一次请求到达后，发现需要借助其他servlet来实现功能
...
负责转发的servlet转发前后的想想正文会丢失

由转发的目的地来响应客户端

在实际开发中，重定向和请求转发都是我们要用到的响应方式，那么他们有什么区别呢？我们通过下面的示例来看一下：

![image-20250313145607941](/Users/zhangjiaqi62/Library/Application Support/typora-user-images/image-20250313145607941.png)
...
![image-20250313160325639](/Users/zhangjiaqi62/Library/Application Support/typora-user-images/image-20250313160325639.png)
