...
| public boolean equals(Object anObject)                       | 比较字符串的内容，严格区分大小写                             | String str1 = "Hello"; <br />String str2 = "Hello"; <br />String str3 = "hello"; System.out.println(str1.equals(str2)); // true System.out.println(str1.equals(str3)); // false |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| public boolean equalsIgnoreCase(String anotherString)        | 比较字符串的内容，忽略大小写                                 | String str1 = "Hello"; <br />String str2 = "Hello"; <br />String str3 = "hello"; System.out.println(str1.equalsIgnoreCase(str2)); // true System.out.println(str1.equalsIgnoreCase(str3)); // true |
| public int length()                                          | 返回此字符串的长度                                           | String str = "Hello World"; <br />System.out.println(str.length()); // 11 |
| public char charAt(int index)                                | 返回指定索引处的 char 值                                     | String str = "Hello World"; System.out.println(str.charAt(0)); // 'H' System.out.println(str.charAt(6)); // 'W' |
| public char[] toCharArray()                                  | 将字符串拆分为字符数组后返回                                 | String str = "Hello World"; <br />char[] chars = str.toCharArray(); <br />System.out.println(chars); // ['H', 'e', 'l', 'l', 'o', ' ', 'W', 'o', 'r', 'l', 'd'] |
| public String substring(int beginIndex, int endIndex)        | 根据开始和结束索引进行截取，得到新的字符串（包含头，不包含尾） | String str = "Hello World"; System.out.println(str.substring(0, 5)); // "Hello" System.out.println(str.substring(6, 11)); // "World" |
| public String substring(int beginIndex)                      | 从传入的索引处截取，截取到末尾，得到新的字符串               | String str = "Hello World"; System.out.println(str.substring(6)); // "World" |
| public String replace(CharSequence target, CharSequence replacement) | 使用新值，将字符串中的旧值替换，得到新的字符串               | String str = "Hello World"; System.out.println(str.replace("World", "Java")); // "Hello Java" |
| public String[] split(String regex)                          | 根据传入的规则切割字符串，得到字符串数组                     | String str = "apple,banana,orange"; <br />String[] fruits = str.split(","); System.out.println(Arrays.toString(fruits)); // ["apple", "banana", "orange"] |
